...
import { User, Mail, Phone, MapPin, Calendar, Save, Edit, Camera, Upload, IdCard } from 'lucide-react';
import {
          ...
          {verificationScore < 70 && (
            <div className="mb-6">
              <VerificationPrompt
                ...
                message="Increase your verification score to unlock all platform features and build tenant trust."
                requiredScore={70}
              ...
              <div className="grid grid-cols-1 gap-4">
                <div>
                  <label className="block text-sm font-medium mb-1">
                    National ID
                    <span className="text-xs text-gray-500 ml-2">(Read-only - managed through verification)</span>
                  </label>
                  <div className="relative">
                    <input
                      type="text"
                      ...
                      disabled={true}
                      className="w-full p-2 pl-10 border rounded bg-gray-50 text-gray-600"
                      placeholder="Not provided"
                    />
                    <IdCard className="absolute left-3 top-1/2 transform -translate-y-1/2 w-4 h-4 text-gray-400" />
                  </div>
                  <p className="text-xs text-gray-500 mt-1">
                    Your National ID is securely stored and can only be updated through the verification process.
                  </p>
                </div>
              </div>
            </div>
            ...
            <div className="bg-white p-6 rounded-lg shadow">
              ...
              <div>
                ...
                <textarea
                  ...
                  rows={4}
                  className="w-full p-2 border rounded focus:ring-2 focus:ring-blue-500 disabled:bg-gray-100"
                  placeholder="Tell tenants about yourself and your experience as a landlord..."
                />
              </div>
            </div>
